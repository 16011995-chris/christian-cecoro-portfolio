                ...
                <div className="min-h-screen flex flex-col justify-center items-center px-6 md:px-24 relative z-10">
                    <div className="flex flex-col items-center">
                        ...
                        <button
                            ...
                            className="h-14 px-10 border border-white/40 text-white font-medium uppercase tracking-widest text-sm rounded-full hover:bg-white hover:text-black transition-all duration-300"
                        >
                            Contact Me
                        </button>
                    </div>
                    ...
                    <div className="max-w-[1400px] mx-auto w-full">
                        <div className="flex justify-between items-end border-t border-white/10 pt-12">
                            ...
                            <div className="text-right">
                                <p className="text-neutral-600 text-sm">© {new Date().getFullYear()}</p>
                            </div>
                        </div>
                    </div>
                </div>
